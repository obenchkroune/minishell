...
SRC_FILES	=	lexer/get_next_token.c lexer/peek.c main.c exec/exec.c exec/redirect.c \
				exec/terminal.c exec/exec_builtins.c exec/exec_simple_cmd.c exec/signals.c \
				builtins/env.c builtins/history.c builtins/unset.c builtins/exit.c builtins/pwd.c \
				builtins/cd.c builtins/export.c builtins/echo.c lib/free_tab.c lib/ft_strreplace.c \
				lib/ft_isspace.c lib/ft_tabsize.c utils/set_pwd.c utils/display_prompt.c \
				utils/syntax_error.c utils/is_empty.c utils/append_input.c utils/init_shell.c \
